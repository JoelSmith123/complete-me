...
module.exports = class Trie {
  ...
  insertRecursive(letterArray, currentNode, word) {
    ...
    // If the letter in currentNode's children property matches
    // the value of the letterArray key, the currentNode is shifted to 
  ...
  suggest(string) {
    ...
    // For the length of the user inputed search string, if the value 
    // of the user inputed search string matches the value of the 
    // current node's children object key, then the currentNode is
    // assigned to the child of the currentNode.
